			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title"><?= $nama_fasilitas->nama_fasilitas ?></h2>
			...
			<div class="row about_row">
				...
				<div class="col-lg-4 about_col about_col_left">
					<div class="about_item">
						<div class="about_item_image"><img src="<?= base_url('foto_fasilitas/'.$value->foto_fasilitas) ?>" width="350px" height="280px"></div>
