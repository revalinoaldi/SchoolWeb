    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-8" >
    				...
    				<div class="courses_container" style="display: inline-flex;" >
    					<div>
    								...
    								<div class="col-lg-6 course_col">
    									<div class="course">
    										...
    										<div class="course_body">
    											<h3 class="course_title"><a href="<?= base_url('home/detail_berita/'.$value->slug_berita) ?>"><?= substr(strip_tags($value->judul_berita),0,28) ?>...</a></h3>
