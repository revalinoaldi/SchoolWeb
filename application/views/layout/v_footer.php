						...
						<div class="col-lg-3 footer_col">
							...
							<div class="footer_section footer_about">
								<div class="footer_logo_container">
									<a href="#">
										<div class="footer_logo_text">SDN UK<br><span class="mt-3">Selatan 18 Pagi</span></div>
									</a>
								</div>
							...
							<div class="footer_section footer_links">
								...
								<div class="footer_links_container">
									<ul>
										...
										<li><a href="<?= base_url() ?>home/video">Video</a></li>
										<li><a href="<?= base_url() ?>home/informasipendaftaran">Pendaftaran</a></li>
...
<script src="<?= base_url() ?>template/front-end/js/blog.js"></script>
